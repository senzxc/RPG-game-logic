        ...
        <section class="max-w-lg w-full flex flex-col items-center justify-center">
            <div class="w-full perspective-1500">
                ...
                <div class="w-full flex gap-4 -rotate-x-30 -rotate-y-45">
                    <button
                        @click = "open2 = !open2"
                        class="group w-full bg-white btn-shadowwhite hover:scale-105 text-[#161e31] text-4xl font-bold p-4 rounded-sm shadow-xl transition duration-200 cursor-pointer">
                        <div class="w-full flex justify-around">
                            <h1>SHOP</h1>
                            <svg class="w-20 text-black/20 group-hover:text-black/80 transition duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M6.00488 9H19.9433L20.4433 7H8.00488V5H21.7241C22.2764 5 22.7241 5.44772 22.7241 6C22.7241 6.08176 22.7141 6.16322 22.6942 6.24254L20.1942 16.2425C20.083 16.6877 19.683 17 19.2241 17H5.00488C4.4526 17 4.00488 16.5523 4.00488 16V4H2.00488V2H5.00488C5.55717 2 6.00488 2.44772 6.00488 3V9ZM6.00488 23C4.90031 23 4.00488 22.1046 4.00488 21C4.00488 19.8954 4.90031 19 6.00488 19C7.10945 19 8.00488 19.8954 8.00488 21C8.00488 22.1046 7.10945 23 6.00488 23ZM18.0049 23C16.9003 23 16.0049 22.1046 16.0049 21C16.0049 19.8954 16.9003 19 18.0049 19C19.1095 19 20.0049 19.8954 20.0049 21C20.0049 22.1046 19.1095 23 18.0049 23Z"></path></svg>
                        </div>
                    </button>
                    <form action="/logout" method="POST"
                        ...
                        <button class="relative w-full flex justify-around cursor-pointer">
                            <h1>LOGOUT</h1>
                            <svg class="w-20 text-black/20 group-hover:text-red-500/80 transition duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M6.26489 3.80698L7.41191 5.44558C5.34875 6.89247 4 9.28873 4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 9.28873 18.6512 6.89247 16.5881 5.44558L17.7351 3.80698C20.3141 5.61559 22 8.61091 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 8.61091 3.68594 5.61559 6.26489 3.80698ZM11 12V2H13V12H11Z"></path></svg>
